...
LIBRARY.books.push({
  title: "The Seryan Line: A Sanitized Institutional Record",
  author: "Standing Council of the Twelve (collective authorship)",
  college: "aureon",
  year: "997 YK",
  restricted: false,
  type: "book",
  content: () => `<p>This volume is the public-record account of the Seryan bloodline of House Vadalis, prepared by the Standing Council of the Twelve in formal collective authorship and released in 997 YK in connection with the Council's broader post-war institutional reorganization. The volume is, by its own framing, a sanitized record; the volume's content does not include the operational details of the bloodline's wartime activities, nor the specific findings of the post-war Council investigation, both of which are held under separate restricted-access arrangements that the volume's reader should understand as governing the broader topic. The volume's purpose is the establishment of a public institutional account that the Council considers appropriate for general scholarly and continental circulation.</p>
<h3>The Bloodline's Origins</h3>
<p>The Seryan bloodline emerged within House Vadalis in approximately 750 YK as one of several specialized magebreeding lineages whose specific work focused on military and defensive applications of the broader Vadalis magebreeding tradition. The bloodline's early work was, by available institutional records, broadly consistent with the standing Vadalis operational practices of the period; the bloodline produced enhanced mounts, working beasts, and certain specialized military-application creatures whose operational characteristics supported ordinary military requirements without exceeding the broader magebreeding tradition's accepted limits. The bloodline's specific institutional position within House Vadalis was, in this early period, that of a respected specialized lineage whose contributions to the broader house were valued and uncontroversial.</p>
<h3>The Long Transition</h3>
<p>The bloodline's transition from the early uncontroversial period to the eventual difficulties that produced the post-war Council intervention was, by the volume's institutional account, gradual across approximately a century. The transition's specific stages are not, in this sanitized account, documented in detail; the transition is treated as a broader institutional drift whose specific operational decisions the volume does not address. The transition produced, by approximately 880 YK, a Seryan operational profile that exceeded the broader Vadalis tradition's limits in ways that the senior Vadalis leadership at the time should have addressed and did not. The volume does not, in its framing, attribute the failure to any specific senior Vadalis figure; the failure is treated as an institutional failure for which the broader Vadalis structure and the broader Twelve oversight share collective responsibility.</p>
<h3>The Wartime Period</h3>
<p>The Last War period (894-996 YK) coincided with the most operationally active phase of the Seryan bloodline's continuing work. The wartime conditions produced demand for the bloodline's specialized products that the bloodline addressed at scales substantially exceeding its pre-war operations. The wartime period also produced, by the volume's institutional account, the conditions under which the bloodline's operational practices reached their most problematic configurations; the wartime conditions reduced the broader Twelve oversight that ordinary peacetime institutional arrangements would have supported, and the bloodline's senior practitioners exercised operational discretion that the post-war Council investigation determined was inappropriate.</p>
<h3>The Post-War Action</h3>
<p>The post-war Council action against the Seryan bloodline was conducted in 996-997 YK following the Treaty of Thronehold and the broader institutional reorganization the Treaty's signatories supported. The Council action included: formal investigation of the bloodline's wartime operational record; identification of specific operational practices that the investigation determined exceeded acceptable limits; institutional sanctions against the bloodline that the volume's later sections describe in summary form; and the broader institutional reform measures that the Council implemented to prevent recurrence of the operational drift the Seryan case represented. The action's specific outcomes are addressed in the volume's appendices, which are themselves prepared in summary form rather than in operational detail.</p>
<h3>The Continuing Name</h3>
<p>The Seryan bloodline continues to exist within House Vadalis under formal institutional arrangements that distinguish the post-action bloodline from its pre-action operational profile. The bloodline retained the Seryan name through the post-war institutional restructuring; the retention reflects the Council's determination that institutional dissolution would have produced collateral consequences exceeding the institutional benefits, and that institutional reform under continuing identity was the appropriate response. The contemporary Seryan bloodline operates under intensive Council and senior Vadalis supervision, with operational practices restricted to limited approved applications whose specific characters the supervising arrangements continuously verify. The bloodline's continuing institutional position is, in current arrangements, the only Vadalis bloodline operating under explicit ongoing post-action supervision; the supervision is intended to be permanent in the foreseeable institutional horizon.</p>
<p class="marginalia">The volume's collective authorship reflects the Council's standing convention for institutional-record publications addressing matters of broader continental significance. The volume's content was prepared through extensive Council consultation and represents the Council's principal public communication on the Seryan matter. Readers seeking more substantive content should be aware that the substantive materials are held under restricted-access arrangements that the volume's preface describes in general terms.</p>`
});

LIBRARY.books.push({
  title: "The Seryan Investigation: Restricted Post-War Findings",
  author: "Standing Inquiry into Wartime Magebreeding Operations",
  college: "tabernacle",
  year: "997 YK",
  restricted: true,
  type: "book",
  content: () => `<p>This volume is the restricted-access companion to the Twelve's sanitized public record on the Seryan bloodline. The volume documents the standing inquiry's actual findings from the post-war investigation into the bloodline's wartime operational practices. The volume is restricted on multiple grounds: the specific operational details would, if generally circulated, provide methodological guidance to parties whose intentions are not aligned with the post-war institutional order; the specific identifications of involved parties would produce continuing political consequences whose management the inquiry has determined is best supported by restricted handling; and the specific findings concerning the surviving creatures and their disposition include information whose wider circulation would compromise the continuing containment operations.</p>
<h3>The Investigation's Scope</h3>
<p>The investigation operated from 996 through 997 YK with the formal authorization of the Standing Council of the Twelve and with the operational cooperation of senior House Vadalis leadership whose interest in the investigation's completion exceeded the bloodline-specific institutional pressures the investigation produced. The investigation's scope included: the bloodline's operational records across the period 880-996 YK, with particular attention to the wartime period; interviews with senior Seryan practitioners under terms that the inquiry's standing protocols established; site investigations at Seryan operational facilities in the Eldeen Reaches periphery, in northern Aundair, in the Vadalis Karrnathi enclave, and at the auxiliary site in eastern Cyre that the Mourning destroyed; and broader institutional interviews with senior Vadalis figures whose knowledge of the bloodline's operations supported the investigation's documentation requirements.</p>
<h3>The Operational Findings</h3>
<p>The investigation's principal operational findings include the following. The bloodline conducted, across the period 920-996 YK, sustained magebreeding operations whose specific products substantially exceeded the limits the broader Vadalis tradition recognizes as appropriate for living-creature work. The products included: enhanced predator combinations whose specific configurations integrated dire-wolf and displacer-beast lineages with additional bloodlines whose introduction the standard magebreeding methodology does not support; multi-source crossbreed creatures whose specific configurations the inquiry has documented in approximately seventy distinct categories, with operational characteristics ranging from limited departures from natural-population baselines to substantial departures whose creature-classifications ordinary natural-history terminology does not adequately accommodate; and specialized terminal-application creatures whose operational profiles were specifically calibrated to single-deployment uses in which the creatures' continuing existence after deployment was not part of the intended operational arrangements.</p>
<h3>The Splicer Practitioners</h3>
<p>The bloodline's senior practitioners adopted, in their internal professional language, the term "splicer" to describe the operational role the most aggressive practitioners conducted. The term is not in standard Vadalis institutional terminology; the term emerged within the Seryan bloodline's internal culture and was used principally in informal communications among the practitioners themselves. The investigation has documented the term's usage across approximately forty internal communications recovered from the bloodline's institutional records and from personal effects recovered at the site investigations. The term refers to the practitioners' self-understanding of their work: the splicing-together of separate creature-source materials into composite living configurations that the natural populations would not produce. The investigation's recommendation is that the term enter the inquiry's standing institutional vocabulary as the appropriate technical designation for the operational role the senior Seryan practitioners conducted.</p>
<h3>The Disposition Findings</h3>
<p>The investigation's findings concerning the disposition of the bloodline's surviving products include the following. At the cessation of the wartime operations, the bloodline maintained continuing inventories of approximately three hundred surviving creatures across the various operational categories. The Council action's disposition arrangements included: immediate destruction of approximately two hundred and twenty creatures whose continuing existence the Council determined posed unacceptable continuing risks; controlled-environment retention of approximately fifty creatures whose continuing study supports the inquiry's continuing investigation requirements, under arrangements that the inquiry's standing operational protocols specify; transfer of approximately twenty creatures to the standing inquiry's secure containment facilities for indefinite retention; and acknowledgment of approximately ten creatures whose disposition the investigation has not been able to definitively determine, with continuing investigation efforts directed toward locating and addressing the unaccounted creatures' current circumstances.</p>
<h3>The Continuing Concerns</h3>
<p>The investigation's continuing concerns include several principal categories. The unaccounted creatures' continuing existence represents a continuing operational concern whose resolution requires continuing investigation. The bloodline's operational records' completeness has not been definitively established; the records the investigation has recovered may not represent the bloodline's complete operational documentation, and additional records may exist in locations the investigation has not identified. The bloodline's continuing operations under post-action supervision require continuing inquiry attention to verify that the supervisory arrangements are operating as intended. The broader institutional questions concerning how the bloodline's drift was permitted to develop without earlier intervention require continuing attention from the broader Council and from the standing inquiry; the institutional lessons the case represents have not been fully extracted, and the continuing institutional reforms the case warrants are not in current circumstances complete.</p>
<p class="marginalia">Trust ledger: Access to this volume is restricted to standing inquiry members, to senior Twelve Council members holding the inquiry's specific authorization, to authorized House Vadalis senior leadership whose institutional positions warrant access, and to parties holding standing Trust authorization with the inquiry's specific approval for this volume. The volume's content is not to be discussed in unsecured settings. The volume's appendices include operational details whose access is governed by additional restrictions beyond access to the main volume. Inquiry has been logged.</p>`
});

LIBRARY.books.push({
  title: "Names That Were Removed: A List of Seryan Excoriates",
  author: "Standing Council of the Twelve (Vadalis subcommittee)",
  college: "aureon",
  year: "997 YK",
  restricted: true,
  type: "book",
  content: () => `<p>This volume is the formal record of the Twelve's post-war excoriations from House Vadalis in connection with the Seryan investigation. The volume identifies the specific individuals whose institutional positions within House Vadalis were formally terminated by Council action and addresses the principal questions the excoriations raise concerning the appropriate scope of post-war institutional accountability for the broader Seryan operational practices. The volume is restricted on the principle that the specific identifications continue to produce political consequences whose management the Council considers best supported by restricted handling.</p>
<h3>The Senior Excoriates</h3>
<p>The Council's senior excoriations from House Vadalis in connection with the Seryan investigation include twenty-three individuals whose institutional positions and specific contributions to the bloodline's operational practices the volume documents. The senior excoriates include: the bloodline's senior practitioner during the wartime period, whose operational decisions the investigation determined produced the most consequential operational drift; the senior practitioner's principal operational deputies, whose individual contributions ranged from direct operational responsibility to enabling-supervision failures; and the senior administrative figures whose institutional positions made them responsible for the broader oversight failures that the operational drift required to develop. The senior excoriates' specific identifications are recorded in the volume's first appendix, which is held under additional restrictions beyond access to the volume itself.</p>
<h3>The Junior Excoriates</h3>
<p>The Council's junior excoriations include approximately forty additional individuals whose specific institutional positions did not warrant senior excoriation but whose individual operational contributions warranted formal institutional separation. The junior excoriates include: practitioners whose direct operational contributions to specific projects exceeded what the investigation determined was appropriate for their institutional positions; administrative personnel whose specific decisions enabled operational practices that should have been prevented through their administrative authority; and certain external contractors and affiliated parties whose continuing institutional relationships with House Vadalis the Council determined were no longer sustainable. The junior excoriates' specific identifications are recorded in the volume's second appendix.</p>
<h3>The Surname Question</h3>
<p>The Council's deliberations included sustained consideration of whether the excoriations should include formal action concerning the Seryan family name. The standard excoriation procedure removes the d'Vadalis prefix from the excoriate's institutional identity but does not, in most precedent cases, address the underlying family name. The Council's investigation produced internal proposals that the Seryan name itself be subjected to formal action — either as collective excoriation of all bearers of the name regardless of individual operational involvement, or as formal Council recommendation that bearers voluntarily adopt alternative family identifications. The proposals were rejected after extended Council deliberation; the rejection's specific reasoning the volume documents in its third appendix.</p>
<p>The contemporary Seryan name continues to be borne by approximately three hundred individuals across the various Vadalis-affiliated populations. The bearers include both excoriated former Vadalis members and continuing Vadalis members whose individual operational records did not warrant excoriation. The bearers' continuing use of the name is, by Council position, their individual prerogative; the Council does not, in current arrangements, exercise authority over the family name as such.</p>
<h3>The Notable Continuations</h3>
<p>The volume's fourth appendix addresses the specific continuing Seryan-name bearers whose institutional positions warrant ongoing Council attention. The appendix includes: continuing Vadalis members whose institutional positions involve continuing magebreeding work, whose practices require continuing supervisory attention to prevent renewed operational drift; excoriated former Vadalis members whose post-excoriation activities continue to warrant continuing Council attention through the standing inquiry's monitoring arrangements; and individual Seryan-name bearers whose institutional positions or operational activities the Council has determined warrant specific continuing attention regardless of their formal Vadalis status. The appendix's content is, by Council practice, updated on annual schedules to reflect changing circumstances among the listed individuals.</p>
<h3>The Implications</h3>
<p>The excoriations and the broader Council action concerning the Seryan bloodline have implications for the continuing institutional development of House Vadalis and the broader Twelve that the volume's concluding section addresses. The implications include: continuing supervision arrangements concerning Vadalis magebreeding operations that exceed the supervision applied to other Vadalis lineages and to other Twelve houses' parallel operations; continuing institutional reform requirements concerning the broader Twelve oversight that the case revealed had been inadequate; and continuing political consequences from the Council action that affect Vadalis's relationships with other Twelve houses and with the broader continental institutional environment. The implications continue to develop and will require continuing Council attention across the foreseeable institutional horizon.</p>
<p class="marginalia">Trust ledger: Access to this volume is restricted to standing inquiry members, to senior Twelve Council members holding the volume's specific authorization, to authorized House Vadalis senior leadership, and to parties holding standing Trust authorization with the Council's specific approval for this volume. The volume's appendices are held under additional restrictions beyond access to the main volume; the four appendices each have separate access protocols specific to their content's particular sensitivity. Inquiry has been logged.</p>`
});

LIBRARY.books.push({
  title: "The Quiet Heir: A Memoir Without Names",
  author: "Anonymous (Seryan-line provenance, deposited 999 YK)",
  college: "lyrris",
  year: "deposited 999 YK",
  restricted: false,
  type: "book",
  content: () => `<p>This document was deposited at the Library through indirect channels in 999 YK. The deposit terms specified anonymous public access. The internal evidence indicates Seryan-line authorship by a continuing Vadalis member whose specific institutional position is not disclosed in the document. The document treats the bloodline's recent institutional history with substantial candor while preserving the author's identity and the identities of other living Seryan-name bearers. The Library's review board considered the deposit terms appropriate and approved public access on the principle that the document's continuing availability serves broader scholarly and continental understanding of the post-war institutional situation.</p>
<h3>The Inheritance</h3>
<p>"I bear the Seryan name. The name is not, in the contemporary continental environment, a name that produces favorable reactions when spoken in unfamiliar company. The name produces, more typically, a particular silence — the silence in which a listener identifies the name's institutional context and decides whether to acknowledge the recognition or to permit the conversation to continue without the recognition becoming an explicit topic. I have, in approximately forty years of bearing the name, observed the silence sufficient times that I am, by ordinary social-pattern measures, an expert in the silence's specific characteristics.</p>
<p>"The silence is the Council's principal continuing accomplishment with respect to the bloodline. The Council's formal actions — the excoriations, the supervisory arrangements, the continuing institutional reforms — are real and consequential. The silence is, in its continuing operation, more consequential than any of the formal actions. The silence shapes the contemporary lives of every Seryan-name bearer in ways that the formal actions do not directly produce. The silence is, by my own continuing assessment, the principal punishment the bloodline carries forward into the post-war period.</p>
<h3>The Public Account</h3>
<p>"The Council's public account of the bloodline — the sanitized institutional record whose preparation produced the published volume that interested readers can consult — is accurate in its broad outlines and incomplete in its specific operational details. The account is, by my own assessment as a continuing Seryan-name bearer who reviewed the published volume on its release, what the public account needed to be. The account establishes the institutional framework within which the post-war bloodline can continue to exist; the account does not provide the operational specifics that would, in continuing circulation, undermine the framework's continued operational support.</p>
<p>"I do not, in this memoir, intend to supplement the public account with operational specifics that the Council determined should not be in general circulation. The memoir is not a corrective. The memoir is a personal account from within the bloodline whose continuing existence the public account establishes — an account of what the bloodline's continuing existence has been like across the post-war period for those of us whose institutional positions and individual operational records did not warrant excoriation but whose continuing presence within the post-action arrangements has been shaped by the broader bloodline circumstances the public account addresses.</p>
<h3>The Daily Reality</h3>
<p>"The daily reality of continuing Seryan-name life is, in its principal external features, ordinary. We work. We engage in our communities. We participate in the broader Vadalis institutional life under the supervisory arrangements the Council has established. The supervision is, in its operational implementation, less intrusive than external observers might assume; the supervision is principally documentary and procedural rather than personally surveilling. The supervision shapes our work but does not substantially shape our personal lives beyond the work.</p>
<p>"The internal reality is more complicated. The bloodline's continuing internal culture includes substantial unresolved engagement with the wartime period. The senior excoriated practitioners are not, in most cases, accessible to the continuing bloodline; the formal excoriations have produced effective separation between the excoriated and continuing populations. The continuing bloodline includes individuals whose family relationships with excoriated practitioners are real and whose continuing engagement with those relationships is shaped by the formal separation in ways that the formal arrangements do not directly address. The continuing bloodline includes individuals whose institutional positions during the wartime period did not warrant excoriation but whose continuing self-assessment includes substantial questions about whether the threshold for excoriation was set at the appropriate level.</p>
<h3>The Coming Years</h3>
<p>"The bloodline's coming years are, in our continuing internal assessment, characterized by gradual development under the continuing supervisory arrangements. The supervision will not, in current Council positions, be terminated within the foreseeable institutional horizon; the supervision is, by Council framing, permanent in the sense that the Council's institutional time horizons recognize permanent. The bloodline will continue to bear the name. The name will continue to produce the silence. The silence will continue to shape our lives in ways that the formal arrangements do not directly produce.</p>
<p>"I am not, in this memoir, requesting reconsideration of the Council's arrangements. The arrangements are, by my own assessment, appropriate to the institutional situation the wartime period produced. I am, in this memoir, simply documenting the continuing reality of bearing the name in the post-war environment. The documentation is, perhaps, valuable. The documentation is, perhaps, only personally meaningful to me. The Library's preservation of the documentation reflects the institution's continuing willingness to support documentation of perspectives that the broader continental discourse does not always make space for. I am grateful for the preservation. I will continue, in the years remaining to me, to bear the name and to participate in the continuing arrangements as the framework establishes."</p>
<p class="marginalia">The Library's review board considered the deposit's terms and concluded that anonymous public access serves broader scholarly understanding without compromising the legitimate continuing privacy interests of the document's author. The author's identification, if it has been determined by the Council's standing investigation arrangements, is not part of the Library's institutional knowledge.</p>`
});


// ─── THE ABOMINATIONS / SPLICER WORK: 4 BOOKS ─────────────────

LIBRARY.books.push({
  title: "What Was Made: A Field Catalog of Outlawed Magebred Creatures",
  author: "Standing Inquiry into Wartime Magebreeding Operations",
  college: "balinor",
  year: "997 YK",
  restricted: true,
  type: "book",
  content: () => `<p>This field catalog documents the principal categories of outlawed magebred creatures produced by the Seryan bloodline during the wartime operational period. The catalog is restricted on multiple grounds: the operational characteristics' specific documentation could provide methodological guidance to parties whose intentions would replicate the outlawed practices; the surviving creatures' specific characterizations remain operationally relevant to the standing inquiry's continuing containment operations; and the broader cataloging structure includes information whose general circulation could affect the post-war institutional arrangements the Council action established. The catalog is intended for use by authorized field investigators, by senior Twelve Council members whose institutional responsibilities require detailed familiarity with the categories, and by parties whose containment-operations work requires specific creature-recognition support.</p>
<h3>The Catalog Structure</h3>
<p>The catalog organizes the outlawed creatures across approximately seventy distinct categories distributed among five principal organizational divisions. <em>The predator-enhancement categories</em>: creatures whose specific configurations enhanced existing predator-population characteristics through magebreeding methods that the standard Vadalis tradition supports for ordinary applications but that the Seryan operations applied at scales and intensities exceeding tradition limits. The dire-wolf and displacer-beast lineages are the most operationally significant categories within this division. <em>The crossbreed combination categories</em>: creatures whose specific configurations integrated multiple-source bloodlines through methods that the standard tradition does not support. <em>The form-modification categories</em>: creatures whose specific configurations modified base-creature physical structures through means whose operational results produced creatures whose form-classifications ordinary natural-history terminology cannot adequately accommodate. <em>The terminal-application categories</em>: creatures whose specific configurations were calibrated to single-deployment operational uses with no provision for continuing existence after deployment. <em>The miscellaneous categories</em>: creatures whose specific configurations do not fit cleanly within the principal divisions and whose individual characterizations the catalog addresses on case-by-case basis.</p>
<h3>The Predator-Enhancement Division</h3>
<p>The predator-enhancement division includes approximately twenty categories whose specific configurations the catalog documents. The principal subcategories include: the Seryan dire wolf variants, comprising approximately eight distinct configurations whose specific characteristics range from limited departures from natural dire-wolf populations to substantial departures whose creature-classification questions the Council action addressed; the displacer-beast variants, comprising approximately six distinct configurations whose specific characteristics included sustained displacement effects, expanded prey-tracking capabilities, and certain configurations whose operational characteristics suggested integration of additional non-displacer-beast bloodline material; the bear variants, comprising approximately three distinct configurations developed primarily for Brelish military applications; and the miscellaneous predator categories whose specific configurations the catalog addresses individually.</p>
<h3>The Crossbreed Combination Division</h3>
<p>The crossbreed combination division includes approximately twenty-five categories whose specific configurations represent the most operationally significant departures from standard magebreeding practice. The crossbreeds integrated multiple-source bloodline material through methods whose specific operational details the catalog documents under the most restrictive access protocols within the broader catalog's restriction framework. The catalog's identification of the crossbreed categories includes: combination-name designations that the bloodline practitioners used in their internal documentation; brief operational-characteristic summaries; the specific deployment records that the investigation has documented; and the disposition status under the Council action's arrangements. The catalog does not, in any category within this division, document the specific bloodline-integration methods that produced the creatures.</p>
<h3>The Terminal-Application Division</h3>
<p>The terminal-application division includes approximately ten categories whose specific configurations represented the most operationally aggressive applications of the bloodline's magebreeding capabilities. The terminal-application creatures were calibrated to single-deployment uses; the calibrations included biological characteristics that produced creature failure within hours or days of deployment, limited reproductive capabilities, and certain configurations whose creature-internal stability was substantially compromised in exchange for operational characteristics that exceeded what stable configurations could produce. The terminal-application categories include several whose specific operational characteristics the catalog identifies as requiring continuing investigation through standing inquiry arrangements; the categories' specific implications for the broader operational understanding remain under continuing development.</p>
<h3>The Continuing Containment</h3>
<p>The catalog's concluding sections address the continuing containment requirements that the disposition arrangements established. The continuing containment includes: the secure facilities at which the retained creatures continue to be held under standing inquiry supervision; the disposition protocols for any unaccounted creatures whose discovery the standing investigation efforts continue to pursue; and the broader continental monitoring arrangements through which any post-disposition creature manifestations would be identified and addressed. The continuing containment is, by inquiry assessment, operationally adequate for the foreseeable institutional horizon; the containment's continuing adequacy depends on factors whose continuing maintenance requires sustained institutional attention.</p>
<p class="marginalia">Trust ledger: Access to this catalog is restricted to standing inquiry members, to authorized field investigators whose containment operations work requires the catalog's content, to senior Twelve Council members holding the catalog's specific authorization, and to parties holding standing Trust authorization with the inquiry's specific approval for this catalog. The catalog's content is not to be discussed in unsecured settings. The catalog's specific subdivisions have additional access restrictions beyond access to the main catalog. Inquiry has been logged.</p>`
});

LIBRARY.books.push({
  title: "The Splicer's Method: Reconstructing an Outlawed Practice",
  author: "Standing Inquiry into Wartime Magebreeding Operations",
  college: "blackdragon",
  year: "998 YK",
  restricted: true,
  type: "book",
  content: () => `<p>This volume reconstructs, through investigation of recovered operational materials and through interviews with parties whose knowledge supported the work, the methodological framework through which the Seryan bloodline's senior practitioners — the splicers, in their internal professional vocabulary — conducted the magebreeding operations that produced the outlawed creatures. The volume is restricted at the highest level the inquiry's standing protocols establish; the methodological reconstruction includes content whose general circulation would directly enable replication of the outlawed practices. The volume is intended for use only by inquiry members whose continuing investigation requires the methodological detail and by selected senior Vadalis practitioners whose continuing supervisory work requires the detail to support effective oversight.</p>
<h3>The Methodology's General Character</h3>
<p>The splicers' methodology departed from the standard Vadalis magebreeding tradition through several principal operational features. The standard tradition operates through controlled lineage development across multiple generations, with magebreeding interventions at specific points in the breeding cycles producing incremental enhancements that the lineage's continuing development consolidates. The splicer methodology compressed the multi-generational timeline through interventions of greater intensity at single points in the breeding cycle, with subsequent stabilization work supporting the rapid integration of changes that the standard tradition develops gradually. The compression produced the operational pace that wartime conditions required; the compression also produced the operational risks that the standard tradition's gradualism is designed to manage.</p>
<h3>The Material Sources</h3>
<p>The splicer methodology drew bloodline material from sources that the standard tradition does not engage with. The sources included: standing populations of natural creatures whose acquisition the standard tradition supports; specialized populations the bloodline maintained for source-material purposes whose specific characteristics the standard tradition would not approve; preserved bloodline material from creatures whose direct acquisition was not feasible, drawn from various preserved-tissue arrangements that the bloodline developed across decades; and certain materials whose specific origins the investigation has not been able to definitively determine, with the investigation's best assessments suggesting that the unidentified sources may include material drawn from territories or populations whose acquisition was not authorized by the entities the materials were drawn from.</p>
<h3>The Integration Techniques</h3>
<p>The bloodline-integration techniques the splicers developed included specific operational practices whose detailed reconstruction the volume documents. The techniques drew on the standard magebreeding methodological foundation while extending the foundation through innovations that the splicers developed across decades of operational practice. The innovations included: focus-item arrangements that supported integrations the standard focus arrangements cannot produce; ritual-protocol modifications that supported sustained intervention windows of greater duration than standard practice supports; and specialized stabilization arrangements that the post-integration creature-development work required for the integrated creatures' viability. The detailed reconstruction occupies the volume's central sections, which are governed by the most restrictive access protocols within the volume's broader restriction framework.</p>
<h3>The Stabilization Problem</h3>
<p>The splicer methodology produced, in its more aggressive applications, integration outcomes whose stability requirements exceeded the bloodline's stabilization capabilities. The volume documents the specific stabilization-failure patterns the investigation has reconstructed; the patterns include: creatures whose initial post-integration appearance was viable but whose continuing development produced configurations the bloodline did not intend; creatures whose integration was unstable across the longer creature-life period but whose initial deployment-readiness was acceptable; and creatures whose integration's stability was adequate but whose operational characteristics exceeded the bloodline's continuing control capabilities. The stabilization-failure patterns produced operational consequences that the bloodline's senior practitioners managed through arrangements whose specific characters the volume documents.</p>
<h3>The Implications for Continuing Containment</h3>
<p>The volume's methodological reconstruction has implications for the continuing containment operations that the disposition arrangements support. The continuing containment must address: the possibility that some surviving creatures' post-integration development continues to produce configurations the disposition arrangements have not adequately characterized; the possibility that the unaccounted creatures' continuing existence in environments outside the inquiry's standing monitoring may produce operational manifestations whose specific characters the methodological reconstruction supports anticipating; and the possibility that the methodological knowledge has not been completely contained within the inquiry's restricted-access arrangements, with the implication that replication efforts by parties outside the inquiry's monitoring may produce continuing operational concerns whose management requires continuing inquiry attention.</p>
<p class="marginalia">Trust ledger: Access to this volume is restricted to the standing inquiry's most senior members, to authorized senior Vadalis supervisory personnel whose institutional positions warrant access, and to parties holding standing Trust authorization with the inquiry's most senior approval for this volume. The volume's central methodological sections are held under additional restrictions beyond access to the main volume. The volume is not to be removed from the inquiry's secure reading facilities under any circumstances. Inquiry has been logged at the senior level.</p>`
});

LIBRARY.books.push({
  title: "The Working Notes of a Splicer",
  author: "Anonymous (recovered Seryan field journal, found 996 YK)",
  college: "blackdragon",
  year: "found 996 YK",
  restricted: true,
  type: "dispatch",
  content: () => `<p>This document is a partial field journal recovered by inquiry investigators at the Seryan auxiliary site in northern Aundair during the post-war investigation. The journal is the working operational notes of a senior Seryan practitioner whose specific identification the inquiry has determined but whose name is not disclosed in this catalog entry per the deposition arrangements. The journal covers approximately the period 962-979 YK and provides direct operational documentation that supplements the broader methodological reconstruction the inquiry's investigation produced. The journal is restricted at the highest level; the working notes include operational details whose general circulation would directly enable replication of the outlawed practices.</p>
<h3>The Journal's Character</h3>
<p>"The journal is, in its principal character, a personal working document rather than an institutional record. The document was prepared by the practitioner for the practitioner's own continuing operational use; the document was not intended for institutional review or for broader circulation. The document's character produces both its operational value (the practitioner documented operational details that institutional records typically omit) and its operational sensitivity (the practitioner documented operational details that institutional records typically omit because their general circulation produces consequences institutional records are designed to avoid).</p>
<h3>Selected Excerpts</h3>
<p>"<em>Sypheros 12, 967 YK.</em> The Karranthal-line stabilization continues to fail at the third stabilization checkpoint. The first three subjects exhibited acceptable post-integration viability through the second checkpoint but produced the characteristic third-checkpoint configuration drift that the prior six-month work was attempting to address. The drift's specific patterns are consistent with the underlying bloodline-incompatibility that the senior practitioners' standing assessment had identified as the principal continuing limitation on the line's operational development. I am inclined to recommend abandonment of the Karranthal line and reallocation of the line's continuing resources to the more promising Vekreth and Gorrath lines, both of which have produced acceptable third-checkpoint outcomes across the past quarter's continuing work.</em></p>
<p>"<em>Eyre 28, 970 YK.</em> The Vekreth deployment results from the Cyran western theater have been received and reviewed. The results exceed our pre-deployment expectations across all principal operational metrics. The deployed creatures' performance against opposing forces produced casualty ratios approximately three times the projected ratios; the creatures' operational survival was longer than projected, with several creatures persisting beyond the deployment-window's intended termination requiring follow-up disposition operations conducted by the deployed forces; and the creatures' deployment-period behavior produced auxiliary operational benefits (terror effects on opposing forces, broader impact on enemy operational coherence) that exceeded the operational benefits the standard creature-deployment doctrine assumes. The senior practitioners' meeting on the results is scheduled for next week; my recommendation will be acceleration of the Vekreth-line production schedule and consideration of additional production resources to support expanded line operations across multiple theaters.</em></p>
<p>"<em>Vult 15, 972 YK.</em> The senior practitioners' meeting concerning the Vekreth-line acceleration produced a decision I do not fully agree with. The decision authorized the acceleration but imposed restrictions on the line's expansion that I believe will limit the line's continuing operational development unnecessarily. The restrictions reflect, by my reading of the meeting's discussions, concerns about Council oversight that I believe are overstated; the wartime conditions provide substantial latitude for accelerated operations that the senior practitioners' more conservative members are not adequately taking advantage of. I will pursue the authorized acceleration within the restrictions while preparing the documentation that will support broader expansion proposals at the next senior practitioners' meeting.</em></p>
<p>"<em>Therendor 7, 975 YK.</em> The Gorrath-line stabilization breakthrough has been achieved through the modified focus-item configuration the past quarter's experimental work developed. The breakthrough produces, by initial assessment, sustainable third-checkpoint outcomes across the principal subcategories. The implications for the line's continuing operational development are substantial; the breakthrough may support expansion of the line's specific applications to operational categories that the prior stabilization limitations had foreclosed. I am preparing the formal report for the senior practitioners' meeting next month and am developing the recommended-applications proposal that will accompany the report.</em></p>
<p>"<em>Aryth 22, 979 YK.</em> The senior practitioners' meeting yesterday produced a decision that requires my continuing attention. The decision authorized expanded operations in directions I believe exceed appropriate limits even in wartime conditions. The decision's specific authorizations include applications whose operational characteristics I am not confident the bloodline's continuing supervisory capabilities are adequate to manage. I expressed my concerns at the meeting; my concerns were noted but did not produce modification of the decision. I will pursue the authorized operations within the decision's framework while preparing the contingency arrangements that will support termination of the operations should the supervisory difficulties I anticipate materialize.</em></p>
<h3>The Termination</h3>
<p>"The journal terminates in late 979 YK without explanation in the recovered material. The journal's continuing entries through subsequent periods may exist in materials the investigation has not recovered; the journal as recovered ends mid-quarter without indication of why the working documentation ceased. The practitioner's institutional position continued through the wartime period; the cessation of the journal does not reflect cessation of the practitioner's continuing work. The practitioner's identity is recorded in the inquiry's identification records and is among the senior excoriated parties documented in the formal excoriation record."</p>
<p class="marginalia">Trust ledger: Access to this document is restricted to standing inquiry members, to authorized senior Vadalis supervisory personnel whose institutional positions warrant access, and to parties holding standing Trust authorization with the inquiry's specific approval for this document. The document is not to be removed from the inquiry's secure reading facilities under any circumstances. Inquiry has been logged at the senior level.</p>`
});

LIBRARY.books.push({
  title: "Deployment Records: The Field Performance of Splicer-Made Creatures",
  author: "Standing Inquiry into Wartime Magebreeding Operations (with Treaty signatory cooperation)",
  college: "drystone",
  year: "998 YK",
  restricted: true,
  type: "book",
  content: () => `<p>This volume documents the field deployment records of the Seryan bloodline's outlawed magebred creatures during the wartime operational period. The volume's preparation has been conducted in cooperation with the Treaty signatory governments whose military forces deployed the creatures during the wartime period; the cooperation has produced access to wartime military records that ordinary post-war scholarly access does not support, with the participating governments' authorization specific to the volume's restricted-access circulation. The volume is restricted on the principle that the deployment records' detailed circulation could produce continuing political consequences whose management the Treaty signatory governments and the inquiry have determined is best supported by restricted handling.</p>
<h3>The Deployment Pattern</h3>
<p>The bloodline's deployment pattern across the wartime period reflects the integration of the bloodline's operational outputs with the Treaty signatory governments' wartime military operations through arrangements whose specific characters varied across the conflict's principal phases. The early wartime period (894-940 YK) produced limited deployment of the bloodline's outputs in standard military applications consistent with the broader Vadalis tradition's wartime contributions. The middle wartime period (940-980 YK) produced expanded deployment in applications that exceeded the standard tradition's operational scope; the expansion reflected both the conflict's continuing intensification and the bloodline's continuing operational development that produced creatures whose operational characteristics supported the expanded applications. The late wartime period (980-996 YK) produced the most aggressive deployment patterns; the deployment reflected both the conflict's continuing pressures and the bloodline's most aggressive operational outputs whose deployment in the prior periods had been more limited.</p>
<h3>The Five-Nation Distribution</h3>
<p>The bloodline's deployment was distributed across all Five Nations' military forces with substantially different deployment intensities reflecting the participating nations' specific operational requirements and the participating military leadership's specific willingness to incorporate the bloodline's outputs. <em>Karrnath</em>: substantial deployment, principally in the Karrnathi northern and eastern military operations whose specific operational requirements the bloodline's outputs supported. <em>Cyre</em>: substantial deployment in the early and middle wartime periods, with reduced deployment in the late wartime period as Cyran command increasingly questioned the operational benefits relative to the broader operational risks. <em>Aundair</em>: moderate deployment principally in specialized operations whose specific operational requirements aligned with the bloodline's specific output characteristics. <em>Breland</em>: limited deployment, principally in defensive operations whose specific configurations supported the bloodline's outputs without requiring the more aggressive applications other nations engaged with. <em>Thrane</em>: minimal deployment, reflecting the Thranish religious-political environment's resistance to creature-deployment applications that the broader Thranish theological tradition viewed with substantial concern.</p>
<h3>The Operational Outcomes</h3>
<p>The deployment outcomes across the principal categories produced operational results that the Treaty signatory governments' wartime records document. The outcomes' principal patterns include: substantial casualty production against opposing forces in deployments where the creatures' operational characteristics produced the projected operational benefits; significant friendly-force casualties in deployments where the creatures' supervisory arrangements proved inadequate to the deployment conditions; auxiliary operational consequences (terror effects, broader operational impact on enemy coherence) whose magnitudes substantially exceeded what standard creature-deployment doctrine projects; and continuing operational complications in the post-deployment phases whose specific characters required follow-up operations exceeding what standard deployment doctrine accommodates.</p>
<h3>The Specific Cases</h3>
<p>The volume's central sections document approximately one hundred and twenty specific deployment cases across the wartime period. The case documentation includes: the deployment's specific date and location; the deploying military formation; the specific creature category deployed; the deployment's operational objectives; the operational results across the principal performance metrics; and the post-deployment disposition arrangements. The case documentation includes both deployments whose operational results were broadly consistent with the deployment expectations and deployments whose operational results substantially exceeded or substantially fell short of expectations. The cases include several whose specific characters the volume documents as warranting continuing inquiry attention concerning long-term consequences that the standard wartime documentation did not adequately characterize.</p>
<h3>The Mournland Question</h3>
<p>The volume's concluding sections address the question of whether the bloodline's deployment patterns and operational outputs are connected to the Day of Mourning. The question is, in current inquiry assessment, not definitively resolved. The available evidence does not establish a direct causal connection between any specific bloodline deployment and the Mourning's specific events; the available evidence also does not foreclose the possibility that the broader operational environment the bloodline contributed to the wartime conditions may have included factors whose cumulative effects contributed to the Mourning's underlying conditions. The inquiry's continuing investigation includes attention to the question; the question's eventual resolution depends on broader Mourning-investigation findings whose continuing development the inquiry's standing arrangements continue to support.</p>
<p class="marginalia">Trust ledger: Access to this volume is restricted to standing inquiry members, to authorized military intelligence personnel of Treaty signatory governments under standing exchange protocols, to senior Twelve Council members holding the volume's specific authorization, and to parties holding standing Trust authorization with the inquiry's specific approval for this volume. The volume's content is not to be discussed in unsecured settings. Inquiry has been logged.</p>`
});


// ─── THE FERAL HEART: 4 BOOKS ─────────────────────────────────

LIBRARY.books.push({
  title: "The Feral Heart: A Public Investigation",
  author: "Inquisitive Tessen d'Medani",
  college: "soladas",
  year: "998 YK",
  restricted: false,
  type: "book",
  content: () => `<p>The Feral Heart is the Vadalis operational branch whose specific institutional configuration places it outside the Eldeen Reaches' geographic boundaries — a placement whose specific characteristics reflect the operational difficulties the broader Reaches druidic communities have produced for Vadalis magebreeding work in their own territories. The Feral Heart's continuing operations have been the subject of sustained external attention from inquisitive investigators, druidic sect representatives, and certain Twelve oversight personnel whose institutional positions warrant continuing engagement with the branch. This volume documents what external investigation has been able to determine about the Feral Heart's contemporary operations and addresses the principal questions that continuing investigation cannot definitively resolve.</p>
<h3>The Geographic Configuration</h3>
<p>The Feral Heart's principal operational sites are located outside the Eldeen Reaches' formal boundaries, in territories whose specific characteristics provide both physical distance from the Reaches' druidic communities and the operational privacy that the branch's work requires. The principal sites include: a substantial facility in northern Aundair whose specific location is not publicly documented; a smaller facility in the Karrnathi border territories whose specific location is similarly undocumented; a third facility whose existence is documented but whose location is not, in available evidence, definitively identified; and various auxiliary support sites whose specific characters the public investigation has not been able to fully characterize. The facilities' geographic distribution reflects deliberate operational distribution rather than concentration; the distribution complicates investigation while providing operational redundancy that single-site arrangements would not support.</p>
<h3>The Operational Profile</h3>
<p>The Feral Heart's operational profile, by available external evidence, includes magebreeding operations that the broader Vadalis tradition considers acceptable for the branch's specific institutional positioning while recognizing that the operations would not be acceptable in Reaches-internal locations where the druidic communities' continuing engagement would produce conflicts the broader tradition prefers to avoid. The operations' specific characters are not, in current external knowledge, fully documented; the available evidence supports operational profiles ranging from moderate departures from standard Vadalis tradition through more substantial departures whose specific characters approach but do not reach the limits the post-war Council action established for the broader Vadalis magebreeding operations.</p>
<h3>The Seryan Connection Question</h3>
<p>The question of whether the Feral Heart's operations include continuing Seryan-line involvement is, in current external investigation, contested. The Council's formal post-war action against the Seryan bloodline included specific provisions concerning the bloodline's institutional positioning that, in their formal terms, foreclosed continuing Seryan involvement in operations of the Feral Heart's character. The available external evidence does not, however, definitively establish whether the formal provisions are operationally implemented at the level the formal terms specify. The Feral Heart's operational profile shares characteristics with the pre-action Seryan operational profile that suggest either continuing Seryan-line technical influence or the development of parallel methodologies whose operational outputs converge on the Seryan-line outputs through different methodological pathways. The investigation has not been able to definitively distinguish between these possibilities.</p>
<h3>The Druidic Position</h3>
<p>The Eldeen Reaches' druidic communities maintain consistent positions on the Feral Heart that the broader continental scholarly community has not adequately engaged with. The positions include: formal condemnation of the branch's operations as representing the most aggressive applications of Vadalis magebreeding that the broader Vadalis tradition supports; sustained sabotage and animal-killing operations against Feral Heart-associated targets that the Ashbound sect in particular conducts under continuing standing operational arrangements; and broader Reaches-internal pressure on House Vadalis to accept further constraints on Feral Heart operations that the contemporary post-war Council oversight has not, in current arrangements, adopted. The druidic positions reflect both ideological commitments concerning the broader natural-order questions the magebreeding operations engage and practical operational concerns concerning specific Feral Heart outputs whose continuing presence in Reaches-adjacent territories the druidic communities have documented.</p>
<h3>The Future Trajectory</h3>
<p>The Feral Heart's future trajectory depends, in current circumstances, on factors that the external investigation can only partially characterize. The principal factors include: the continuing post-war Council oversight that the broader Vadalis institutional environment supports; the continuing Reaches druidic pressure that the branch must continue to manage; the continuing demand from external commercial and military parties whose interest in the branch's specific outputs sustains the branch's institutional viability; and the broader continental institutional environment whose continuing development will shape the operational space within which the branch can continue to operate. The trajectory's specific evolution will continue to be the subject of inquisitive investigation; the volume's preparation represents a current waypoint in continuing investigation rather than a definitive characterization.</p>
<p class="marginalia">Inquisitive Tessen d'Medani's investigation into the Feral Heart has been conducted under standing Medani contracts with several Five Nations governments and with selected Reaches-aligned parties whose continuing operational interest in the branch supports the investigation. The volume represents the externally-publishable portion of the investigation's findings; additional findings are held under confidential terms specific to the participating clients.</p>`
});

LIBRARY.books.push({
  title: "Ashes and Ashes: An Ashbound Polemic Against the Feral Heart",
  author: "Druid-Speaker Korrak of the Ashbound",
  college: "tabernacle",
  year: "997 YK",
  restricted: false,
  type: "book",
  content: () => `<p>I write this volume against the institutional preferences of my own sect, whose senior leadership holds that direct external publication exceeds the appropriate operational scope for our continuing work against the Vadalis abominations. I write nonetheless. The continuing operations of the Feral Heart and of the broader Vadalis magebreeding tradition produce harms that exceed what the sect's preferred internal-action approach can adequately address; the harms require external recognition that the sect's own preferred operational approach does not produce. The volume is, in this framing, my own personal contribution to the continuing engagement; the volume does not represent the formal Ashbound institutional position, and the senior leadership has indicated that institutional sanctions for the publication may be forthcoming. I publish nonetheless.</p>
<h3>The Theological Foundation</h3>
<p>The Ashbound theological foundation holds that natural creatures occupy specific roles in the broader cosmological-natural order and that interventions modifying those roles through magical means represent fundamental violations of the natural order whose continuing operation depends on the integrity of the role-arrangements. The position is not, in its principal content, novel; the position has been the Ashbound theological foundation since the sect's establishment, and the position continues to be maintained across the sect's contemporary scholarly work. The position has implications for the broader Vadalis magebreeding tradition that the volume's continuing engagement develops.</p>
<p>The standard Vadalis magebreeding tradition operates through interventions that the broader continental position considers acceptable applications of magical capability. The Ashbound position holds that the tradition's continuing operations are not acceptable; the tradition's accumulated outputs across its institutional history represent sustained violations of the natural-order arrangements whose cumulative consequences the tradition's continuing operations cannot avoid. The position has, across the sect's continuing history, produced sustained engagement with the tradition that has included formal theological documentation, organized opposition operations, and the broader continuing institutional work the sect maintains.</p>
<h3>The Feral Heart's Specific Character</h3>
<p>The Feral Heart represents, within the broader Vadalis tradition's institutional configuration, the most operationally aggressive applications of the tradition's capabilities. The branch's operational outputs include creatures whose specific configurations exceed even the broader tradition's standard limits. The branch's operational positioning reflects, by the institution's own internal logic, recognition that the branch's outputs cannot be produced within Reaches-internal locations where Reaches druidic communities — the Wardens of the Wood, the Greensingers, the Children of Winter, and my own Ashbound — would prevent the production through the operational means our respective sects have developed. The Feral Heart's positioning is, in this framing, an institutional acknowledgment that the branch's work cannot be conducted in the presence of competent natural-order defense.</p>
<h3>The Splicer Continuation</h3>
<p>The post-war Council action against the Seryan bloodline produced formal institutional outcomes that the Council represents as adequate to address the wartime operational difficulties. The Council's representation is, by my own assessment as a senior Ashbound practitioner whose continuing operational work has included extensive Feral Heart engagement, substantially inaccurate. The Feral Heart's continuing operations include methodological elements that are operationally indistinguishable from the splicer methodology the Council action formally addressed. The continuation may reflect formal Seryan-line involvement that the Council's supposed restrictions do not actually prevent; the continuation may reflect the development of parallel methodologies whose operational outputs converge on the splicer outputs through different methodological pathways. The institutional consequences are, in either case, equivalent: the splicer methodology continues to produce splicer outputs through Feral Heart operational arrangements, and the Council's continuing public position that the methodology has been suppressed is operationally inaccurate.</p>
<h3>The Continuing Operations</h3>
<p>The Ashbound's continuing operations against the Feral Heart and the broader Vadalis magebreeding tradition include sustained sabotage against branch operational sites, targeted destruction of specific magebred creatures whose continuing existence the operations identify as warranting termination, and broader operational engagement that the sect's standing arrangements support. The operations are, by external observation, the most operationally aggressive of the four Reaches druidic sects' positions on the broader Vadalis tradition. The operations are, by the sect's own continuing assessment, inadequate to the broader institutional scale of the tradition's continuing work; the operations address specific operational outputs without producing the broader institutional change the tradition's continuing operation requires.</p>
<h3>The Honest Assessment</h3>
<p>The honest assessment of the Ashbound position is that the sect cannot, through the operational means the sect's institutional configuration supports, prevent the continuing operations of the Feral Heart or the broader Vadalis magebreeding tradition. The sect can complicate the operations. The sect can produce institutional pressure that limits the operations' scope. The sect cannot end the operations through the operational means available to the sect. The operations will continue. The continuing operations will continue to produce the harms the volume's framework characterizes. The continuing harms will require continuing engagement that the sect's continuing work attempts to provide.</p>
<p>I do not write this volume to claim that the Ashbound position is operationally adequate. I write the volume to ensure that the broader continental scholarly discourse includes the Ashbound position's substantive content rather than the more limited characterizations the broader discourse typically produces. The position deserves substantive engagement. The volume is my contribution to that engagement.</p>
<p class="marginalia">Druid-Speaker Korrak of the Ashbound writes from a small grove in the southern Reaches periphery. The volume's publication has produced, by reports reaching the Library, the formal sect-internal censure that the author's preface anticipated; the author has indicated continuing intention to remain in active sect operations regardless of the censure's specific provisions.</p>`
});

LIBRARY.books.push({
  title: "Crossing the Boundary: A Reaches-Adjacent Operational Geography",
  author: "Wayfinder Field Officer Aldis ir'Vahn",
  college: "morridan",
  year: "998 YK",
  restricted: false,
  type: "book",
  content: () => `<p>This volume documents the operational geography of the territories adjacent to the Eldeen Reaches whose specific characters support the Feral Heart's continuing institutional configuration. The volume is intended for use by Wayfinder Foundation operators whose continuing work in the affected territories requires familiarity with the operational landscape; the volume is also intended for broader scholarly engagement with the geographic-institutional questions the Feral Heart's positioning raises. The volume's preparation has been conducted with cooperation from senior Wayfinder Foundation leadership and with selected senior Reaches druidic representatives whose contributions to the volume's accuracy the preface acknowledges.</p>
<h3>The Boundary Region's Character</h3>
<p>The territories adjacent to the Reaches' formal boundary include a continuous region whose specific characteristics reflect both the Reaches' continuing institutional influence and the broader external institutional environment. The region's principal features include: ecological transitions between the Reaches' substantial wilderness territories and the more developed external territories whose specific characters reflect the broader Five Nations agricultural and commercial development; political transitions across multiple jurisdictions whose specific arrangements concerning the Reaches' formal status produce variable institutional environments; and infrastructural transitions whose specific characters support both the broader continental commercial environment and the more localized operational requirements specific to the boundary region's particular configurations.</p>
<h3>The Northern Aundair Sites</h3>
<p>The northern Aundair sites associated with Feral Heart operations are located in territories whose specific characters support the operational requirements the branch's work produces. The sites' specific locations are not publicly documented in this volume; the volume's continuing engagement with the sites operates at the regional rather than site-specific level. The northern Aundair territories provide several operational advantages to the branch: continuing Aundairian Crown willingness to support magebreeding operations whose specific characters align with Crown military and commercial interests; continuing distance from Reaches druidic operational reach that the more directly Reaches-adjacent territories do not support to the same degree; and continuing infrastructural support that the broader Aundairian commercial environment provides for substantial operational requirements that smaller-scale operational environments could not match. The sites' specific operational characteristics are, by available external knowledge, consistent with the Crown's continuing supportive engagement.</p>
<h3>The Karrnathi Border Sites</h3>
<p>The Karrnathi border sites associated with Feral Heart operations are located in territories whose specific configurations reflect both Karrnathi internal arrangements and the broader Karrnathi-Reaches frontier dynamics. The sites are smaller in scale than the northern Aundair sites and serve different operational functions; the sites' specific operational characters reflect specialized applications rather than the broader operational scope the larger sites support. The Karrnathi sites' continuing operations have been the subject of sustained Sentinel Marshal investigation under arrangements that several Five Nations governments have supported; the investigations have produced findings whose specific characters are restricted but whose broader implications support the volume's general characterization of the sites' operational profile.</p>
<h3>The Third Site Question</h3>
<p>The volume documents external evidence concerning the existence of a third Feral Heart operational site whose specific location has not been definitively determined. The evidence includes: financial-flow patterns that the inquisitive investigations have identified as consistent with operational support for an additional site; supply-chain patterns that the broader Sivis-supported logistical analysis has identified as supporting consumption volumes consistent with three-site operations rather than two-site operations; and certain specific operational outputs whose distribution patterns the field investigations have identified as consistent with three-source rather than two-source production arrangements. The evidence does not, in current circumstances, support definitive identification of the third site's specific location; the evidence does support the conclusion that the third site exists and is operating at scales comparable to the documented sites.</p>
<h3>The Auxiliary Support Network</h3>
<p>The Feral Heart's operational arrangements include auxiliary support sites whose specific characters support the principal sites' continuing operations without conducting magebreeding operations of their own. The auxiliary sites include: supply-acquisition arrangements that source the materials the principal sites' work requires; transport arrangements that move both raw materials and finished operational outputs across the broader operational geography; commercial-distribution arrangements that connect the principal sites' outputs with the external markets whose continuing demand sustains the branch's institutional viability; and administrative-support arrangements whose specific characters support the broader institutional operations the branch maintains. The auxiliary sites are distributed across substantially broader territories than the principal sites; the broader distribution reflects the auxiliary sites' lower operational sensitivity and their consequent ability to operate in more diverse institutional environments.</p>
<h3>The Operational Implications</h3>
<p>The operational geography's specific characteristics produce implications for parties whose continuing engagement with the Feral Heart's operations the volume's preparation supports. The implications include: continuing investigative requirements whose specific characters require sustained operational presence in the broader operational geography rather than concentrated investigation at specific sites; continuing diplomatic requirements concerning the Five Nations governments whose territorial sovereignty the operational geography crosses; continuing engagement requirements with the Reaches druidic communities whose continuing operational interests intersect with the operational geography's specific characters; and continuing institutional engagement requirements with House Vadalis whose continuing institutional position concerning the branch's operations remains incompletely characterized in publicly available materials.</p>
<p class="marginalia">Wayfinder Field Officer Aldis ir'Vahn's volume on the operational geography reflects extensive Foundation field work in the affected territories supplemented by cooperation from senior Reaches druidic representatives whose continuing operational interests in the territories support the volume's accuracy. The volume is published with formal Foundation authorization and is used, in modified form, in the Foundation's continuing operational training programs.</p>`
});

LIBRARY.books.push({
  title: "Field Report: An Anonymous Defector's Testimony",
  author: "Anonymous (Feral Heart defector, deposited 999 YK)",
  college: "blackdragon",
  year: "deposited 999 YK",
  restricted: true,
  type: "dispatch",
  content: () => `<p>This document was deposited at the Library through indirect channels in 999 YK by a former Feral Heart practitioner whose continuing personal safety required deposit terms specifying restricted access and anonymous attribution. The Library's review board considered the deposit terms appropriate and approved restricted access on the principle that the document's content provides operationally important information whose continuing availability serves broader scholarly and institutional understanding while preserving the legitimate continuing safety interests of the document's author.</p>
<h3>The Defector's Position</h3>
<p>"I was, until early 999 YK, a junior practitioner in the Feral Heart's northern Aundair operations. My institutional position included direct involvement in the magebreeding work that the branch's operational outputs require. My specific operational responsibilities included support for senior practitioners whose institutional positions warranted operational discretion that my own institutional position did not warrant. I am, by the broader Twelve Council's formal terms, neither a senior practitioner nor a party whose institutional position warranted formal post-war Council attention. I am also, by my own continuing self-assessment, a participant in operational arrangements whose continuing operation produces consequences that I am no longer willing to participate in.</p>
<p>"I left the operations in early 999 YK through arrangements that the Wayfinder Foundation's continuing operational support has made feasible. The departure's specific arrangements are not documented in this report; the arrangements continue to support my continuing safety, and their disclosure would compromise the safety arrangements. I am writing this report from a location whose specific identification is similarly not documented. The report's preparation has been conducted with the operational support of the parties whose continuing assistance my continuing safety depends on; the parties have indicated that the report's eventual deposit at the Library serves broader scholarly and institutional understanding without compromising the continuing safety arrangements.</p>
<h3>The Operational Reality</h3>
<p>"The Feral Heart's continuing operations include, in their actual implementation, methodological elements that the broader Vadalis tradition's public characterizations do not adequately address. The methodologies include direct application of techniques whose specific characters the Council's formal post-war action against the Seryan bloodline supposedly suppressed. The application's specific institutional configuration involves practitioners whose individual identifications include both former Seryan-line practitioners whose excoriation status the Council's formal action established and continuing practitioners whose institutional positions did not warrant formal action but whose operational practices include the methodological elements the Council action supposedly suppressed.</p>
<p>"The continuing operations produce outputs whose specific characters include both creatures consistent with the formally-permitted Vadalis tradition and creatures whose specific configurations exceed the tradition's formally-permitted limits. The exceeding creatures are produced under arrangements that limit the broader external visibility of their existence; the creatures are not deployed in operations whose external observation would produce institutional consequences, but the creatures exist within the branch's continuing operational arrangements. The creatures' specific characters are, in some cases, comparable to the wartime Seryan-line outputs that the Council action's disposition arrangements addressed; the creatures' continuing existence in the contemporary post-war environment represents continuation of the practices the Council action's public position represents as suppressed.</p>
<h3>The Splicer Identification</h3>
<p>"The continuing operations include practitioners whose internal professional self-identification employs the splicer terminology that the wartime Seryan-line practitioners developed. The terminology's continuing use within the contemporary Feral Heart operations indicates either direct institutional continuity with the wartime practitioner population or deliberate adoption of the wartime terminology by the contemporary practitioners whose institutional positioning may or may not include direct wartime continuity. The terminology's continuing use is, in either case, operationally significant: the terminology represents the continuing institutional culture within which the operations are conducted, and the culture's continuing operation supports the methodological practices the terminology was developed to characterize.</p>
<h3>The Continuing Concerns</h3>
<p>"My principal continuing concerns concerning the operations include the following. The operations' continuing institutional viability depends on the broader Vadalis institutional support that the Council's continuing oversight arrangements supposedly limit; the operational reality is that the institutional support continues at levels that the formal oversight arrangements do not adequately address. The operations' specific outputs include creatures whose continuing existence the broader continental institutional environment is not adequately equipped to manage if the creatures' continuing existence becomes more publicly visible. The operations' continuing methodological development represents continued development of the splicer methodology that the Council action supposedly suppressed; the methodology's continuing development produces continuing operational outputs whose specific characters exceed the methodology's wartime developments.</p>
<h3>The Recommendations</h3>
<p>"The recommendations I offer through this report are not for any specific institutional party; the recommendations are for the broader scholarly and institutional environment whose continuing engagement with the operations the report supports. The recommendations include: continuing investigative attention to the operations through the Wayfinder Foundation, the Sentinel Marshals, and the inquisitive networks whose institutional positions support continuing investigation; continuing skeptical engagement with the Council's public characterizations of the post-war institutional outcomes, on the principle that the public characterizations do not adequately reflect the operational reality the report documents; and continuing scholarly attention to the broader institutional questions concerning how the post-war institutional arrangements have permitted continuing operations of the kind the report documents."</p>
<p class="marginalia">Trust ledger: Access to this document is restricted to standing inquiry members, to authorized Wayfinder Foundation senior personnel whose institutional positions warrant access, to Sentinel Marshal Senior Council members holding the document's specific authorization, and to parties holding standing Trust authorization with the inquiry's specific approval for this document. The document's content is not to be discussed in unsecured settings. The document's deposit terms include continuing arrangements concerning the author's safety that govern any operational use of the document's content. Inquiry has been logged.</p>`
});


// ─── ROUNDING OUT: 1 BOOK ON THE 12 INSTITUTIONAL RESPONSE ────

LIBRARY.books.push({
  title: "The Council's Post-War Reform: An Institutional History",
  author: "Triumvir-Scholar Tessen Ghallanda (ret.)",
  college: "aureon",
  year: "999 YK",
  restricted: false,
  type: "book",
  content: () => `<p>The Council of the Twelve's post-war institutional reform — the broader institutional changes that the Council implemented in connection with the Treaty of Thronehold and the cessation of wartime operations — is one of the most consequential institutional developments of the contemporary continental period. The reform's specific provisions addressed multiple institutional questions whose continuing implications continue to shape the contemporary continental institutional environment. The Seryan-bloodline action is, by available external assessment, the single most operationally consequential element of the broader reform. This volume documents the reform's principal provisions and addresses the principal questions the reform raises concerning the Council's continuing institutional development.</p>
<h3>The Reform's Origins</h3>
<p>The reform's origins lie in the broader institutional pressures that the wartime period produced for the Council and the dragonmarked houses. The wartime conditions had produced institutional drift across multiple houses whose specific characters varied by house but whose cumulative effects produced post-war institutional environments that the participating houses' senior leaderships recognized as warranting structured response. The Seryan bloodline's specific operational drift was the most operationally aggressive single case but was not, in the broader assessment, an isolated case; multiple houses' wartime operations had developed institutional practices that the post-war environment required to be addressed through structured reform rather than through informal institutional adjustment.</p>
<h3>The Reform's Principal Provisions</h3>
<p>The reform's principal provisions, by the public institutional record, include several substantive institutional changes. <em>Enhanced inter-house oversight arrangements</em>: the reform established expanded oversight arrangements among the participating houses whose specific operational characters support continuing institutional accountability across house boundaries. The arrangements address the wartime pattern in which individual houses' internal oversight proved inadequate to identify and address operational drift through internal processes alone. <em>Expanded standing investigation capabilities</em>: the reform established expanded standing investigation capabilities under Council authority whose institutional positioning provides continuing investigative capacity beyond what individual houses' internal arrangements support. The capabilities include the Standing Inquiry into Wartime Magebreeding Operations whose work the volume's earlier sections address. <em>Specific bloodline-action arrangements</em>: the reform established formal arrangements for action against specific bloodlines whose wartime operational records warranted institutional response; the Seryan action is the principal published example, while additional bloodline-action arrangements concerning other houses' bloodlines are documented in restricted institutional records that this volume does not address.</p>
<h3>The Reform's Broader Implications</h3>
<p>The reform's broader implications for the Council's continuing institutional position include several substantial developments. The reform strengthened the Council's institutional position relative to the participating houses; the expanded oversight arrangements give the Council direct operational authority that the pre-reform Council did not exercise. The reform produced increased institutional integration among the participating houses; the expanded inter-house arrangements produce continuing operational coordination that the pre-reform institutional environment did not support to the same degree. The reform produced expanded institutional engagement with external parties — particularly with Treaty signatory governments and with selected scholarly institutions including the Korranberg Library — whose continuing engagement supports the reform's continuing operational implementation.</p>
<h3>The Continuing Tensions</h3>
<p>The reform's continuing tensions include several institutional questions whose continuing development requires sustained Council attention. <em>The implementation question</em>: the reform's formal provisions are not, in available external evidence, fully implemented at the level the formal provisions specify. The Feral Heart investigations the volume's earlier sections reference indicate continuing operational realities that exceed the reform's formal limits. The implementation question's continuing development requires continuing Council attention. <em>The expansion question</em>: the reform's specific scope addresses certain wartime operational practices but does not address others whose institutional implications may warrant comparable treatment. The continuing scope discussions concern questions whose specific characters the broader Council institutional environment continues to develop. <em>The duration question</em>: the reform's specific provisions are framed as continuing institutional arrangements rather than time-limited responses to specific wartime conditions. The continuing-arrangement framing produces questions concerning the appropriate eventual evolution of the arrangements as the post-war environment continues to develop.</p>
<h3>The Honest Assessment</h3>
<p>The honest assessment of the reform is that the reform represents substantive institutional response to the wartime period's institutional drift while remaining incomplete in its operational implementation. The reform is real. The reform produces real continuing institutional consequences. The reform is also not adequate, in current circumstances, to the full institutional questions the wartime period produced. The continuing institutional development that the reform initiated will continue to require sustained attention from the Council and from the broader continental institutional environment that the Council operates within. The continuing development is not, in current circumstances, complete; the continuing development will continue across the foreseeable institutional horizon.</p>
<p class="marginalia">Triumvir-Scholar Tessen Ghallanda's volume on the Council's post-war reform draws on the author's continuing scholarly engagement with the Council's institutional history and on extensive consultation with senior Council members whose continuing institutional positions support the volume's accuracy. The volume is published with formal Council acknowledgment and represents one of the more substantive recent treatments of the reform available in continental scholarly publication.</p>`
});
